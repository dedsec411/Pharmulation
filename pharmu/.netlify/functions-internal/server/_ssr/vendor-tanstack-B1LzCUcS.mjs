...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BR4rfVnm.mjs");
...
const manifest = {
  "6998d5bda3c8f203fdc10234018043ebcfba19eaea0dab1a9b324f1a8d498e87": {
    ...
    importer: () => import("./chat.functions-DNXpdAk_.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BNcp_T-P.mjs").then((n) => n.r),
    import("./start-InXhOG72.mjs"),
