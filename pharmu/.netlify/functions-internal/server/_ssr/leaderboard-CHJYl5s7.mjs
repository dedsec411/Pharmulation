...
import { P as PUBLIC_MODE_GROUPS } from "./shared-Bfopko4w.mjs";
import { B as BackButton } from "./BackButton-DOnk_vvq.mjs";
import { N as Navbar } from "./Navbar-BMmnf87p.mjs";
import "../_libs/sonner.mjs";
import "../_libs/seroval.mjs";
import { M as MonitorDot, T as Trophy, A as Activity, n as Crown, U as UserRound } from "../_libs/lucide-react.mjs";
...
function LeaderboardPage() {
  ...
  const {
    ...
    queryFn: async () => {
      ...
      const scoreResults = await Promise.all(activeFilter.modes.map((mode) => supabase.rpc("get_public_scores", {
        mode_in: mode,
        since: sinceIso
      })));
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    profile && /* @__PURE__ */ jsxRuntimeExports.jsx(Navbar, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "mx-auto max-w-5xl px-6 py-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BackButton, { to: profile ? "/dashboard" : "/", label: profile ? "Dashboard" : "Home" }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-5 flex gap-2 flex-wrap rounded-2xl border border-cyan-300/10 bg-black/20 p-2 shadow-inner", children: FILTERS.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setFilter(item.key), className: `text-xs rounded-full px-3 py-1.5 transition ${filter === item.key ? "bg-primary/20 text-primary border border-primary/40 shadow-[0_0_18px_-8px_oklch(0.74_0.14_180)]" : "bg-white/[0.04] text-muted-foreground hover:bg-white/[0.08]"}`, children: item.label }, item.key)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative mt-8 overflow-hidden rounded-3xl border border-cyan-300/20 bg-black/35 p-4 shadow-[0_0_70px_-34px_oklch(0.74_0.14_180),inset_0_0_50px_-30px_oklch(0.74_0.14_180)] backdrop-blur-xl", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex items-center justify-between gap-3 rounded-2xl border border-cyan-300/15 bg-cyan-300/[0.04] px-4 py-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-mono text-xs text-muted-foreground", children: [
            activeFilter.label,
            " - ",
            scope === "weekly" ? "7 day board" : "all time board"
          ] })
        ] }),
        top3.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative mt-5 grid grid-cols-3 gap-3 items-end", children: [1, 0, 2].map((idx) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-12 w-12 mx-auto rounded-xl border border-primary/35 bg-primary/15 text-primary grid place-items-center font-bold shadow-[0_0_20px_-8px_oklch(0.74_0.14_180)]", children: playerInitial(p.full_name) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 font-bold text-sm truncate", children: cleanPlayerName(p.full_name) }),
