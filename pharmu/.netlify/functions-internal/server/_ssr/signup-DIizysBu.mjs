...
import { l as lovable } from "./index-C23rlpqB.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-h-screen flex items-center justify-center px-4 py-10", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSignup, className: "space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { required: true, value: fullName, onChange: (e) => setFullName(e.target.value), placeholder: "Full name", className: "w-full rounded-xl glass px-4 py-3 outline-none focus:border-primary" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { required: true, type: "password", minLength: 6, value: password, onChange: (e) => setPassword(e.target.value), placeholder: "Password (min 6 chars)", className: "w-full rounded-xl glass px-4 py-3 outline-none focus:border-primary" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { value: role, onChange: (e) => setRole(e.target.value), className: "w-full rounded-xl glass px-4 py-3 outline-none focus:border-primary", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { disabled: loading, className: "w-full rounded-full bg-primary py-3 font-semibold text-primary-foreground hover:scale-[1.02] transition disabled:opacity-60", children: loading ? "Creating…" : "Create account" })
      ] }),
